...
#-cerveza: podra disparar 2 veces en un turno a el usuario o oponente
...
vidas = 4
vidasOP = 4
items = ["Lupa","cuchillo", "cerveza", "cigarro", "telefono", "Swaper", "daga", "cambio"]
inventario = []
inventariOP = []
DañoArma = 1
...
# Menu de inicio
def menu():
    print("Bienvenido a Buckshot Roulette v1.0")
    print("1) Jugar")
    print("2) Reglas")
    print("3) Salir")
...
#Item de cerveza: podra disparar 2 veces en un turno
def cerveza():
    print("Cerveza: borracho pero con suerte diparas 2 veces")
    #mas tarde
...
# Turno del oponente
def turnoOP():
    opciones = [dispararTurnOP, dispararUSTurnOP]
